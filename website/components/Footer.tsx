    ...
    <footer className="bg-background border-t border-white/10 py-16">
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between gap-y-10">
          {/* Left side */}
          <div className="max-w-[200px] mr-8 md:mr-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-16 gap-y-8 text-sm">
            ...
            <div>
              {/* Social links populated from lib/site.ts */}
              ...
              <div className="flex gap-4 text-muted">
                {site.social?.linkedin && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 hover:text-accent transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent rounded"
                    aria-label="Michael Hart on LinkedIn"
                  >
