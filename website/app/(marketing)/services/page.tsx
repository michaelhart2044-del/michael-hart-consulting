...
export const metadata: Metadata = {
  title: 'Services',
  description: 'Specialized advisory services including forensic accounting & litigation support, M&A advisory, business structuring, financial forecasting, and AI & automation solutions.',
  openGraph: {
      ...
      <div className="max-w-5xl mx-auto px-6 pt-32 pb-16">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg text-muted">
            We deliver specialized, high-stakes advisory across complex financial, strategic, and operational challenges. Each engagement is tailored, rigorous, and focused on clear outcomes.
          </p>
        </div>
      </div>
